...
config :poo_storm, PooStormWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "avM4SZ5aFAVXz74rzEsZKnW6H+lNeuGOE94Htws7snXPi6aVtW8m8tHKwM5DadaB",
  watchers: []
...
config :poo_storm, PooStormWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/poo_storm_web/(live|views)/.*(ex)$",
      ~r"lib/poo_storm_web/templates/.*(eex)$"
    ]
  ]
